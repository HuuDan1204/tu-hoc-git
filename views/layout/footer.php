        ...
        <div class="footer-top section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            <h6 class="widget-title">Lien he </h6>
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Minh Khai - Vũ Thư</li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">dannhph48355@fpt.edu.vn </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">0395069694</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2022 <b></b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>HasThemes</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
